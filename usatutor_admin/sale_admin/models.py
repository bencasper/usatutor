...
class SaleOrderCourse(models.Model):
    ...
    course_duration = models.DecimalField(max_digits=10, decimal_places=2, blank=False, default=0.00)
    course_tutor_id = models.PositiveIntegerField(null=False)
    course_tutor_name = models.CharField(max_length=100, null=False)
    course_student_id = models.PositiveIntegerField(null=False, default=0)
    course_student_name = models.CharField(max_length=100, null=False, default='')
    course_status = models.PositiveIntegerField(null=False, choices=COURSE_STATUS, default=1)
