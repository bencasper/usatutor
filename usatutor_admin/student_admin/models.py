...
class StudentInfo(models.Model):
    ...
    user_sex = models.IntegerField(null=False, verbose_name='性别', choices=USER_SEX)
    ...
    ing_course = models.IntegerField(default=0, verbose_name='未上')
    done_course = models.IntegerField(default=0, verbose_name='已上')
